...
//filament diameter hole, ripped from upstream Prusa
filament_diameter=3;
...
module peek_guard() {
    difference() {
        ...
        union() {
            ...
            //fan vent
            translate([0,20.6,-23.35]) rotate([90,0,0]) cylinder(r1=11.8,r2=5,h=7.2,center=true,$fn=30);    //r2=6 for 40 degree,  r2=5 for 45ish!

            //slotted peek section clearance
            translate([0,12,-23.75]) cylinder(r=10,h=16.5,center=true,$fn=30);
            translate([0,0,-23.75]) cube(([20,24,16.5]),center=true);

            //filament
            translate([0,12,0]) cylinder(r=filament_feed_hole_d/2,h=60,center=true,$fn=10);
